      ...
      <div className="flex flex-wrap items-center justify-between gap-4 pb-4 border-b border-sentinel-border">
        <div>
          ...
          <p className="text-xs font-sans text-slate-400 mt-0.5">
            &ldquo;Replay realistic campus safety scenarios without physical hardware.&rdquo;
          </p>
        </div>

        {/* Big Judge Demo Button */}
        <button
          onClick={launchJudgeDemo}
          className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-slate-950 font-mono font-bold text-xs uppercase tracking-wider transition-all shadow-lg shadow-cyan-500/20 hover:scale-105 cursor-pointer"
        >
          <Zap className="w-4 h-4 fill-current" />
          <span>Launch Judge Demo (Deterministic Fire Scenario)</span>
        </button>
      </div>
